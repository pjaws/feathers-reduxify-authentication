...
exports.default = function (app) {
  ...
  return {
    ...
    authenticate: (0, _reduxActions.createAction)(AUTHENTICATE, function (p) {
      return { promise: app.authenticate(p), data: undefined };
    }),
